...
start(function(err, topics) {
	...
	parseTheTopics(topics)
		.then(function(response) {
			...
			}, error =>  console.log("The parseTheTopics promise has failed.", error) )
		.then(function(response) {
				return queryForFeeds();
				// getFeedUrls returns a promise that resolves with an array of RSS feed IDs, market IDs and URLs.
			}, error =>  console.log("The queryForFeeds promise has failed", error) ) 
			})
		.then(function(urls) {
		...
		.then(function(feeds) {
			...
			}, error => console.error("The getFeed promise has failed.", error) )
		.then(function(response) {
